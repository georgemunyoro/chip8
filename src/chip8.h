...
private:
    ...
    */
    ...
    // non-zero. This timer does nothing more than subtract 1 from the value of
    // DT at a rate of 60Hz. When DT reaches 0, it deactivates.
    uint8_t delayTimer;
    ...
    // as ST's value is greater than zero, the Chip-8 buzzer will sound. When ST
...
const uint8_t NUMBER_SPRITES[16][5]
